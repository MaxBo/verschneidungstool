...
class Ui_Upload(object):
    def setupUi(self, Upload):
        ...
        self.layoutWidget_2 = QtWidgets.QWidget(Upload)
        ...
        self.OK_button = QtWidgets.QPushButton(self.layoutWidget_2)
        ...
        self.gridLayoutWidget = QtWidgets.QWidget(self.upload_frame)
        self.gridLayoutWidget.setGeometry(QtCore.QRect(10, 20, 531, 250))
        self.gridLayoutWidget.setObjectName("gridLayoutWidget")
        self.upload_layout = QtWidgets.QGridLayout(self.gridLayoutWidget)
        self.upload_layout.setContentsMargins(0, 0, 0, 0)
        self.upload_layout.setObjectName("upload_layout")
        self.gridLayout_4 = QtWidgets.QGridLayout()
        self.gridLayout_4.setObjectName("gridLayout_4")
        self.schema_combo = QtWidgets.QComboBox(self.gridLayoutWidget)
        ...
        self.shapefile_edit = QtWidgets.QLineEdit(self.gridLayoutWidget)
        self.shapefile_edit.setObjectName("shapefile_edit")
        self.gridLayout_4.addWidget(self.shapefile_edit, 0, 1, 1, 1)
        self.shapefile_browse_button = QtWidgets.QPushButton(self.gridLayoutWidget)
        ...
        self.projection_combo = QtWidgets.QComboBox(self.gridLayoutWidget)
        ...
        self.check_projection_button = QtWidgets.QPushButton(self.gridLayoutWidget)
        ...
        self.encoding_combo = QtWidgets.QComboBox(self.gridLayoutWidget)
        self.encoding_combo.setObjectName("encoding_combo")
        self.horizontalLayout_3.addWidget(self.encoding_combo)
        self.custom_encoding_edit = QtWidgets.QLineEdit(self.gridLayoutWidget)
        ...
        self.upload_button = QtWidgets.QPushButton(self.gridLayoutWidget)
        self.upload_button.setObjectName("upload_button")
        self.horizontalLayout.addWidget(self.upload_button)
        self.upload_layout.addLayout(self.horizontalLayout, 3, 0, 1, 1)
        self.message_edit = QtWidgets.QTextEdit(self.gridLayoutWidget)
        ...
        self.gridLayoutWidget_2 = QtWidgets.QWidget(self.identifiers_frame)
        self.gridLayoutWidget_2.setGeometry(QtCore.QRect(10, 20, 531, 93))
        self.gridLayoutWidget_2.setObjectName("gridLayoutWidget_2")
        self.select_ids_layout = QtWidgets.QGridLayout(self.gridLayoutWidget_2)
        self.select_ids_layout.setContentsMargins(0, 0, 0, 0)
        self.select_ids_layout.setObjectName("select_ids_layout")
        self.pkey_combo = QtWidgets.QComboBox(self.gridLayoutWidget_2)
        self.pkey_combo.setObjectName("pkey_combo")
        self.select_ids_layout.addWidget(self.pkey_combo, 1, 1, 1, 1)
        self.names_combo = QtWidgets.QComboBox(self.gridLayoutWidget_2)
        ...
        self.hst_combo = QtWidgets.QComboBox(self.gridLayoutWidget_2)
