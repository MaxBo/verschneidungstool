...
#
# Created: Fri Jul 15 13:19:45 2016
...
class Ui_Upload(object):
    def setupUi(self, Upload):
        ...
        self.encoding_combo = QtGui.QComboBox(self.gridLayoutWidget)
        self.encoding_combo.setObjectName(_fromUtf8("encoding_combo"))
        self.horizontalLayout_3.addWidget(self.encoding_combo)
        self.custom_encoding_edit = QtGui.QLineEdit(self.gridLayoutWidget)
        self.custom_encoding_edit.setEnabled(False)
        self.custom_encoding_edit.setObjectName(_fromUtf8("custom_encoding_edit"))
    ...
    def retranslateUi(self, Upload):
        ...
        self.label_8.setText(_translate("Upload", "Encoding", None))
